...
function Banner() {
  return (
        <div className='relative w-full h-[400px] bg-[url(../src/assets/softwareengineer.jpg)] bg-cover bg-center bg-no-repeat'>
          <div className='flex justify-between items-start p-5 lg:hidden xl:hidden 2xl:hidden '>
            <button>
              <img className="w-16" src="../src/assets/left-arrow.png" alt="" />
            </button>
